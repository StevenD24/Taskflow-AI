                    ...
                    {(provided, snapshot) => (
                        <div
                            ...
                            className={`pb-2 p-2 rounded-2xl shadow-sm ${
                                snapshot.isDraggingOver ? "bg-green-100/50" : "bg-white/50"
                            }`}
                        >
                            <h2 className="flex justify-between font-bold text-xl p-2">
                                ...
                                px-2 py-1 text-sm font-normal">
                                    {!searchString ? todos.length : todos
                                        .filter(todo => todo.title.toLowerCase().includes(searchString
                                        .toLowerCase())).length}
                                </span>
                            </h2>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-end justify-end p-2">
                                    <button onClick={handleAddTodo} className="text-green-500/90 hover:text-green-600">
                                        <PlusCircleIcon 
                                            className="h-10 w-10"
                                        />
                                    </button>
